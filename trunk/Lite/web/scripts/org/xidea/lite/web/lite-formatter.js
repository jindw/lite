...
var EIS = [VALUE_CONSTANTS,VALUE_VAR,VALUE_LIST,VALUE_MAP,OP_GET,OP_INVOKE,OP_NOT,OP_BIT_NOT,OP_POS,OP_NEG,OP_MUL,OP_DIV,OP_MOD,OP_ADD,OP_SUB,OP_LT,OP_GT,OP_LTEQ,OP_GTEQ,OP_EQ,OP_NE,OP_EQ_STRICT,OP_NE_STRICT,OP_BIT_AND,OP_BIT_XOR,OP_BIT_OR,OP_AND,OP_OR,OP_QUESTION,OP_QUESTION_SELECT,OP_JOIN,OP_PUSH]
var ENS = "VALUE_CONSTANTS,VALUE_VAR,VALUE_LIST,VALUE_MAP,OP_GET,OP_INVOKE,OP_NOT,OP_BIT_NOT,OP_POS,OP_NEG,OP_MUL,OP_DIV,OP_MOD,OP_ADD,OP_SUB,OP_LT,OP_GT,OP_LTEQ,OP_GTEQ,OP_EQ,OP_NE,OP_EQ_STRICT,OP_NE_STRICT,OP_BIT_AND,OP_BIT_XOR,OP_BIT_OR,OP_AND,OP_OR,OP_QUESTION,OP_QUESTION_SELECT,OP_JOIN,OP_PUSH"
var EIN = map(EIS,ENS);
var TIN = map(TIS,TNS);
//alert(TIN)
