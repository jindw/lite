...
//add as default
function TextParserOld(nativeJS){
 ...
 * @private
 */
TextParserOld.prototype = new Parser();
TextParserOld.prototype.parse = function(url){
...
//parse text
TextParserOld.prototype.addParser(function(node){
...
TextParserOld.prototype.parseText = function(text,xmlText,xmlAttr){
    if(!text){
        return [];
    }
 ...
 */
TextParserOld.prototype.parseEL = function(expression){
