...
def test(req):
    output = req;
    #new Template(["3*7=",[EL_TYPE,[[VALUE_CONSTANTS,3],[VALUE_CONSTANTS,7],[OP_MUL]]],"\r\n"]).render({},output);
