...
import org.xidea.el.fn.ECMA262Impl.URIComponent;
...
public class ECMA262FunctionTest {
	...
	public void testEncodeURLComponentEL() throws Exception{
		...
		el = factory.create("decodeURIComponent('a%E9%87%91%E5%A4%A7%E4%B8%BA')");
...
//		System.out.println(decodeURIComponent.invoke("1+2"));
	...
	public void testEncodeURL() throws Exception{
		Map<String, String> encodeMap = new LinkedHashMap<String, String>();
		//encodeMap.put("+", "%2B");
		encodeMap.put("http://www.xidea.org/金+大+为", "http://www.xidea.org/%E9%87%91%2B%E5%A4%A7%2B%E4%B8%BA");
